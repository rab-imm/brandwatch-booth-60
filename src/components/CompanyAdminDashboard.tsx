        ...
        <SidebarProvider>
          <div className="flex min-h-[calc(100vh-4rem)] w-full">
            ...
            <main className="flex-1 flex flex-col overflow-hidden">
              <div className="border-b p-4 flex items-center justify-between bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h1 className="text-2xl font-bold text-amber-900 dark:text-amber-100">Admin Control Panel</h1>
                      <p className="text-sm text-amber-700 dark:text-amber-300">{company?.name}</p>
                    </div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
