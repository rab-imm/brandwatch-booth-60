-- Insert correct test data based on constraints
...
-- Insert billing alerts with correct alert types
...
((SELECT user_id FROM profiles LIMIT 1), 'billing_issue', 'high', 'Payment Failed', 'Your recent payment attempt failed. Please update your payment method.'),
